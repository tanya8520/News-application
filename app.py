...
mydb = mysql.connector.connect(host="localhost", user="root", password="rathore17#", database="NEWS")
...
def search_result():
    if request.method == 'POST':        
        ...
        url = f"https://newsapi.org/v2/everything?q={search_query}&apiKey=fb24c888fa434b9b8ef193e325351028"
        req = requests.get(url).json()
        search_result = {
            'articles' : req['articles']
        }
